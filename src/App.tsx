...
const App: Component = () => {
  return (
    <div class='font-Rubik p-4'>
      ...
      <div class=''>
        <div class='h-[309] bg-[rgb(22,22,22)] lg:flex justify-around items-center'>
